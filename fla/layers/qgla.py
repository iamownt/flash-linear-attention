...
from fla.modules import FusedRMSNormSwishGate, RMSNorm, ShortConvolution, Qttn
...
class QGatedLinearAttention(nn.Module):
    r"""
    ...
    def __init__(
        ...
        self.qttn = Qttn(lora_alpha=lora_alpha, r=low_rank, hidden_size=hidden_size)
    ...
    def forward(
        ...
        **kwargs
        ...
        gk = self.gk_proj(self.qttn(hidden_states))
